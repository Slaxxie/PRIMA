...
(function (WhiteWater) {
    ...
    async function init(_event) {
        ...
        WhiteWater.uiNode.appendChild(new WhiteWater.UserInterface(-10.7, 10, "leftpanel.png"));
        WhiteWater.uiNode.appendChild(new WhiteWater.UserInterface(10.7, 10, "rightpanel.png"));
